...
export default function SymptomsPage() {
  ...
  useEffect(() => {
    setSymptoms(storage.symptoms.getAll());
  }, []);
  ...
  function saveSymptom() {
    ...
    storage.symptoms.save(s);
    storage.activity.push({
      type: "symptom",
      label: `Logged symptom: ${s.symptom} (severity ${s.severity})`,
      at: s.loggedAt,
    });
    setSymptoms(storage.symptoms.getAll());
    setShowForm(false);
          ...
          messages: [
            {
              role: "user",
              content:
                "Review these symptom logs for a patient. Identify any patterns, recurring issues, or things a caregiver should bring up with a doctor.",
            },
          ],
                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-2 flex-wrap">
                      ...
                      <span className={severityClass(s.severity)}>
                        Severity {s.severity} — {SEVERITY_LABELS[s.severity]}
                      </span>
                    </div>
                    {s.notes && (
          ...
          <div className="bg-white rounded-2xl p-6 w-full max-w-md shadow-xl space-y-4">
            ...
            <div>
              <label className="label">
                Severity: {form.severity} — {SEVERITY_EMOJI[form.severity]}{" "}
            ...
            <div className="flex gap-3 pt-2">
              <button onClick={saveSymptom} className="btn-primary flex-1">
                Log Symptom
              </button>
